...
- **Check** `.gitignore` before pushing (should exclude `secret.properties`, `bot-model.txt` content with real keys, etc.)
- Backend uses HTTP/1.1 with FastAPI — don't downgrade protocol negotiation
