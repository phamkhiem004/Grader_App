...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void _save() {
    ...
    // LỖI 1: kiểm dữ liệu xong rồi... QUÊN GỌI LƯU. Form vẫn xoá trắng như đã lưu được.
    setState(() {
      _editingId = null;
  ...
  void _startEdit(User user) {
    // LỖI 2: nút sửa nối rồi nhưng thân hàm còn trống — chưa nạp dữ liệu vào form, và vì
    // _editingId không được đặt nên dòng "Đang sửa người dùng" cũng không hiện.
  }
  ...
  void _openDetail(User user) {
    // LỖI 3: nút xem chi tiết chưa mở màn hình nào.
  }
  ...
  Widget _buildForm() {
    return Column(
      ...
      children: <Widget>[
        Row(
          children: <Widget>[
            // LỖI 5: dùng emoji trong Text thay vì một Icon thật.
            const Text('👥', key: ValueKey<String>('icon.header')),
        ...
        // LỖI 6: khoảng cách giữa hai ô nhập là 24, đề đòi 8.
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        // LỖI 4: thiếu hẳn nút xoá hết danh sách.
